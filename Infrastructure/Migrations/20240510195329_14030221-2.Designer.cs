...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240510195329_14030221-2")]
    partial class _140302212
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Entities.AnsweredTestDetail", b =>
                {
                    ...
                    b.Property<long>("AnsweredTestId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domains.Entities.AnsweredTestDetail", b =>
                {
                    b.HasOne("Domains.Entities.AnsweredTest", "AnsweredTest")
                        .WithMany("Details")
                        .HasForeignKey("AnsweredTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domains.Entities.Choice", "Choice")
                        .WithMany("AnsweredTestDetails")
            ...
            modelBuilder.Entity("Domains.Entities.Choice", b =>
                {
                    b.Navigation("AnsweredTestDetails");
                });
